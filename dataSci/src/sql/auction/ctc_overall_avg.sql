/* Table 1 - Ad Calls */
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac as
    select 
        site_type,
        publisher_user_id,
        request_id,
...
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_i
;
create table
 intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_i as
select request_id,
       external_id, 
       advertiser_id,
       auction_position
...
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_i;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_i as
    select
     ac.*,
     i.auction_position,
     i.external_id,
     i.advertiser_id 
    from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac ac
      left join intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_i i
...
/* Table 3a - Optional table - Filtering for only advertisers who are also publishers
   ...
   AUCSIM_PPA_auction_vpc_ac_i */
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_p;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_p as 
     select
     ac.*
     from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_i ac
...
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ad;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ad as
    select
...
;
 ...
 /* Table 5 - Clicks */
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c as
    select
        c.site_type, 
        c.request_id,
    ...
    inner join intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ad ad
...
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c_p;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c_p as 
     select
     c.*,
     p.site_id as piggybacked_advertiser_site_id
     from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c c
     inner join intent_media_sandbox_production.conversion_piggybacked_advertisers p
     on c.advertiser_id = p.advertiser_id
;
        
/* Table 7 - Deduped Conversions */
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_con;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_con as
    select 
        con.request_id,
...
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_con_c;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_con_c as
        select
        ...
        from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_con con
        inner join intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c_p c 
...
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c_con;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c_con as
    select
        c.ad_call_request_id,
        c.publisher_user_id,
        c.webuser_id,
    ...
    left join 
        ...
        from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_con_c con_c
        inner join 
            (select 
                con_request_id,
                min(con_c_time_diff) as min_con_c_time_diff
            from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_con_c
...
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_c;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_c as
    select 
        ac.*,
    ...
    from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_p ac
    left join intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_c_con c 
    on ac.external_id = c.external_impression_id;

/* Table 11 - Final table */
drop table if exists intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_final;
create table intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_final as
    select 
        site_type,
        advertiser_id,
        result_page_number,
    ...
    from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_ac_c
...
select sum(clicked_conversion_count) / sum(clicks)
from intent_media_sandbox_production.AUCSIM_PPA_auction_vpc_final;
