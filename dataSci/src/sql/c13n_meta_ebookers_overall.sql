...
from
	...
	ad_unit_type='META' 
	-- and ad_unit_id = 129
	and site_type = 'EBOOKERS'
	and requested_at_date_in_et between '2014-05-28' and '2014-09-22' -- start 2014-03-20 pricing bug fixed 2014-04-01
	and ip_address_blacklisted = 0
	group by 1) as 
uvs left join
	(select
	publisher_user_id,
	(conversion_value * 0.151) as net_conversion_value,
	requested_at_in_et
	from
	...
	site_type = 'EBOOKERS'
	and entity_id = 55
	and requested_at_date_in_et between '2014-05-28' and '2014-09-22'
