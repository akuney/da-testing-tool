/* Table 1 - Ad Calls */
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac as
    select 
        site_type,
        publisher_user_id,
        request_id,
        ...
        where requested_at_date_in_et between '2014-07-01' and '2014-08-31'
...
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_i
;
create table
 intent_media_sandbox_production.SP_PPA_auction_conv_overlap_i as
select request_id,
       external_id, 
       advertiser_id
...
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_i;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_i as
    select
     ac.*,
     i.external_id,
     i.advertiser_id 
    from intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac ac
      left join intent_media_sandbox_production.SP_PPA_auction_conv_overlap_i i
...
/* Table 3c - Filtering for only advertisers who are also publishers
   ...
   simply use SP_PPA_auction_conv_overlap_ac_m */
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_p;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_p as 
     select
     ac.*
     from intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_i ac
...
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ad;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ad as
    select
...
;
 ...
 /* Table 5 - Clicks */
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c as
    select
        c.site_type, 
        c.request_id,
    ...
    inner join intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ad ad
        on c.advertisement_id = ad.advertisement_id
    where c.requested_at_date_in_et between '2014-07-01' and (date('2014-08-31') + interval '1 day')
        and ac.requested_at_date_in_et between '2014-07-01' and '2014-08-31'
...
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c_p;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c_p as 
     select
     c.*,
     p.site_id as piggybacked_advertiser_site_id
     from intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c c
     inner join intent_media_sandbox_production.conversion_piggybacked_advertisers p
     on c.advertiser_id = p.advertiser_id
;
        
/* Table 7 - Deduped Conversions */
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_con;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_con as
    select 
        con.request_id,
    ...
    inner join 
        ...
        where requested_at_date_in_et between '2014-07-01' and (date('2014-08-31') + interval '31 day')
...
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_con_c;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_con_c as
        select
        ...
        from intent_media_sandbox_production.SP_PPA_auction_conv_overlap_con con
        inner join intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c_p c 
...
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c_con;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c_con as
    select
        c.ad_call_request_id,
        c.publisher_user_id,
        c.webuser_id,
    ...
    left join 
        ...
        from intent_media_sandbox_production.SP_PPA_auction_conv_overlap_con_c con_c
        inner join 
            (select 
                con_request_id,
                min(con_c_time_diff) as min_con_c_time_diff
            from intent_media_sandbox_production.SP_PPA_auction_conv_overlap_con_c
...
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_c;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_c as
    select 
        ac.*,
    ...
    from intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_p ac
    left join intent_media_sandbox_production.SP_PPA_auction_conv_overlap_c_con c 
    on ac.external_id = c.external_impression_id;

/* Table 11 - Final table */
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_final;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_final as
    select 
        advertiser_id,
        hotel_property_id,
        ...
        case when sum(click_count) = 0 then -1.0
                else sum(clicked_conversion_count)/sum(click_count) as clicked_conversion_rate,
    ...
    from intent_media_sandbox_production.SP_PPA_auction_conv_overlap_ac_c
...
/* Analysis */
drop table if exists intent_media_sandbox_production.SP_PPA_auction_conv_overlap_results;
create table intent_media_sandbox_production.SP_PPA_auction_conv_overlap_results as
select
e.name as advertiser,
t1.*
from
intent_media_sandbox_production.SP_PPA_auction_conv_overlap_final t1
