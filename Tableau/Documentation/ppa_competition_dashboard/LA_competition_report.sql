...
DROP TABLE IF EXISTS  Intent_media_sandbox_production.LA_ppa_competition_stage_1;
CREATE TABLE Intent_media_sandbox_production.LA_ppa_competition_stage_1
 AS
        ...
        and i.ip_address_blacklisted = false         
                ...
                and publisher_hotel_price > 0 AND a.requested_at_date_in_et = to_date('12/20/2014','mm/dd/yyyy')
...
GRANT ALL on Intent_media_sandbox_production.LA_ppa_competition_stage_1 to PUBLIC;
 

--------- CREATE a row for publisherID and then rank each row by Advertiser

DROP TABLE IF EXISTS  Intent_media_sandbox_production.LA_ppa_competition_stage_2;
CREATE TABLE Intent_media_sandbox_production.LA_ppa_competition_stage_2
AS
...
FROM 
        ...
        FROM Intent_media_sandbox_production.LA_ppa_competition_stage_1 a
...
GRANT ALL on Intent_media_sandbox_production.LA_ppa_competition_stage_2 to PUBLIC;

---- Create 5 sets of the same data with each Advertiser occupying the first slot once

DROP TABLE IF EXISTS  Intent_media_sandbox_production.LA_ppa_competition_stage_3;
CREATE TABLE Intent_media_sandbox_production.LA_ppa_competition_stage_3
AS

SELECT b.*, ru.runner_up
FROM
(SELECT a.*, 1 as meta_rank FROM Intent_media_sandbox_production.LA_ppa_competition_stage_2 a
...
FROM Intent_media_sandbox_production.LA_ppa_competition_stage_2
...
FROM Intent_media_sandbox_production.LA_ppa_competition_stage_2) b
LEFT OUTER JOIN 
...
GRANT ALL on Intent_media_sandbox_production.LA_ppa_competition_stage_3 to PUBLIC;

------------ Transpose each set into a single line

DROP TABLE IF EXISTS  Intent_media_sandbox_production.LA_ppa_competition_stage_4;
CREATE TABLE Intent_media_sandbox_production.LA_ppa_competition_stage_4
AS
...
FROM 
        ...
        FROM Intent_media_sandbox_production.LA_ppa_competition_stage_3
        WHERE torder = 1 ) a
...
GRANT ALL on Intent_media_sandbox_production.LA_ppa_competition_stage_4 to PUBLIC;



DROP TABLE IF EXISTS  Intent_media_sandbox_production.EA_ppa_competition_report_12202014;
CREATE TABLE Intent_media_sandbox_production.EA_ppa_competition_report_12202014
AS

--INSERT INTO intent_media_sandbox_production.EA_ppa_competition_report_12302014
SELECT 
...
--        SUM(advertiser_price_1) as SUM_advertiser_price_1, 
--        SUM(advertiser_price_2) as SUM_advertiser_price_2,
--        SUM(advertiser_price_3) as SUM_advertiser_price_3,
--        SUM(advertiser_price_4) as SUM_advertiser_price_4,
--        SUM(advertiser_price_5) as SUM_advertiser_price_5,       
                                 
--        SUM(advertiser_price_1^2) as SUM_advertiser_price_1_sqr, 
--        SUM(advertiser_price_2^2) as SUM_advertiser_price_2_sqr,
--        SUM(advertiser_price_3^2) as SUM_advertiser_price_3_sqr, 
--        SUM(advertiser_price_4^2) as SUM_advertiser_price_4_sqr,
--        SUM(advertiser_price_5^2) as SUM_advertiser_price_5_sqr,                                      
                                   
--        SUM(advertiser_price_1 - advertiser_price_2) as SUM_Price_Differences_2,
--        SUM(advertiser_price_1 - advertiser_price_3) as SUM_Price_Differences_3,
--        SUM(advertiser_price_1 - advertiser_price_4) as SUM_Price_Differences_4, 
--        SUM(advertiser_price_1 - advertiser_price_5) as SUM_Price_Differences_5,  
                                   
--        SUM((advertiser_price_1 - advertiser_price_2)^2) as SUM_Price_Differences_sqr_2,
--        SUM((advertiser_price_1 - advertiser_price_3)^2) as SUM_Price_Differences_sqr_3,
--        SUM((advertiser_price_1 - advertiser_price_4)^2) as SUM_Price_Differences_sqr_4,
--        SUM((advertiser_price_1 - advertiser_price_5)^2) as SUM_Price_Differences_sqr_5, 
...
--        SUM(((advertiser_price_1 - advertiser_price_2)/advertiser_price_2)^2) as SUM_PRCT_Differences_sqr_2,        
--        SUM(((advertiser_price_1 - advertiser_price_3)/advertiser_price_3)^2) as SUM_PRCT_Differences_sqr_3,
--        SUM(((advertiser_price_1 - advertiser_price_4)/advertiser_price_4)^2) as SUM_PRCT_Differences_sqr_4,
--        SUM(((advertiser_price_1 - advertiser_price_5)/advertiser_price_5)^2) as SUM_PRCT_Differences_sqr_5,
        
        --MIN(advertiser_price_1 - advertiser_price_2) as MIN_Price_Differences_2,
        --MIN(advertiser_price_1 - advertiser_price_3) as MIN_Price_Differences_3,
        --MIN(advertiser_price_1 - advertiser_price_4) as MIN_Price_Differences_4,
        --MIN(advertiser_price_1 - advertiser_price_5) as MIN_Price_Differences_5,
                                               
        --MAX(advertiser_price_1 - advertiser_price_2) as MAX_Price_Differences_2,
        --MAX(advertiser_price_1 - advertiser_price_3) as MAX_Price_Differences_3,
        --MAX(advertiser_price_1 - advertiser_price_4) as MAX_Price_Differences_4,
        --MAX(advertiser_price_1 - advertiser_price_5) as MAX_Price_Differences_5,                        
        
        --MIN((advertiser_price_1 - advertiser_price_2)/advertiser_price_2) as MIN_PRCT_Differences_2,
        --MIN((advertiser_price_1 - advertiser_price_3)/advertiser_price_3) as MIN_PRCT_Differences_3,
        --MIN((advertiser_price_1 - advertiser_price_4)/advertiser_price_4) as MIN_PRCT_Differences_4,
        --MIN((advertiser_price_1 - advertiser_price_5)/advertiser_price_5) as MIN_PRCT_Differences_5,
                                                
        --MAX((advertiser_price_1 - advertiser_price_2)/advertiser_price_2) as MAX_PRCT_Differences_2,
        --MAX((advertiser_price_1 - advertiser_price_3)/advertiser_price_3) as MAX_PRCT_Differences_3,
        --MAX((advertiser_price_1 - advertiser_price_4)/advertiser_price_4) as MAX_PRCT_Differences_4,
        --MAX((advertiser_price_1 - advertiser_price_5)/advertiser_price_5) as MAX_PRCT_Differences_5,
 ...
 --wins       
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2  <= -1 Then advertiser_price_1 ELSE null END) as WINS_SUM_advertiser_2_1_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2  <= -1 Then advertiser_price_2 ELSE null END) as WINS_SUM_advertiser_2_2_price,

--        SUM(case WHEN advertiser_price_1 - advertiser_price_3  <= -1 Then advertiser_price_1 ELSE null END) as WINS_SUM_advertiser_3_1_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3  <= -1 Then advertiser_price_3 ELSE null END) as WINS_SUM_advertiser_3_3_price,
        
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4  <= -1 Then advertiser_price_1 ELSE null END) as WINS_SUM_advertiser_4_1_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4  <= -1 Then advertiser_price_4 ELSE null END) as WINS_SUM_advertiser_4_4_price,
        
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5  <= -1 Then advertiser_price_1 ELSE null END) as WINS_SUM_advertiser_5_1_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5  <= -1 Then advertiser_price_5 ELSE null END) as WINS_SUM_advertiser_5_5_price,
--sqr
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2  <= -1 Then advertiser_price_1^2 ELSE null END) as WINS_SUM_advertiser_2_1_sqr_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2  <= -1 Then advertiser_price_2^2 ELSE null END) as WINS_SUM_advertiser_2_2_sqr_price,

--        SUM(case WHEN advertiser_price_1 - advertiser_price_3  <= -1 Then advertiser_price_1^2 ELSE null END) as WINS_SUM_advertiser_3_1_sqr_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3  <= -1 Then advertiser_price_3^2 ELSE null END) as WINS_SUM_advertiser_3_3_sqr_price,
        
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4  <= -1 Then advertiser_price_1^2 ELSE null END) as WINS_SUM_advertiser_4_1_sqr_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4  <= -1 Then advertiser_price_4^2 ELSE null END) as WINS_SUM_advertiser_4_4_sqr_price,
        
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5  <= -1 Then advertiser_price_1^2 ELSE null END) as WINS_SUM_advertiser_5_1_sqr_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5  <= -1 Then advertiser_price_5^2 ELSE null END) as WINS_SUM_advertiser_5_5_sqr_price,        
--diff                     
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2  <= -1 Then advertiser_price_1 - advertiser_price_2 ELSE null END) as WINS_SUM_Price_Differences_1_2,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3  <= -1 Then advertiser_price_1 - advertiser_price_3 ELSE null END) as WINS_SUM_Price_Differences_1_3, 
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4  <= -1 Then advertiser_price_1 - advertiser_price_4 ELSE null END) as WINS_SUM_Price_Differences_1_4, 
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5  <= -1 Then advertiser_price_1 - advertiser_price_5 ELSE null END) as WINS_SUM_Price_Differences_1_5,                       
--diff^2 
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 <= -1 Then (advertiser_price_1 - advertiser_price_2)^2 ELSE null END) as WINS_SUM_Price_Differences_sqr_1_2, 
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 <= -1 Then (advertiser_price_1 - advertiser_price_3)^2 ELSE null END) as WINS_SUM_Price_Differences_sqr_1_3,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 <= -1 Then (advertiser_price_1 - advertiser_price_4)^2 ELSE null END) as WINS_SUM_Price_Differences_sqr_1_4,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 <= -1 Then (advertiser_price_1 - advertiser_price_5)^2 ELSE null END) as WINS_SUM_Price_Differences_sqr_1_5,                        
--Prct Diff        
...
--Prct Diff^2
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 <= -1 Then ((advertiser_price_1 - advertiser_price_2)/advertiser_price_2)^2 ELSE null END) as WINS_SUM_PRCT_Differences_sqr_1_2,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 <= -1 Then ((advertiser_price_1 - advertiser_price_3)/advertiser_price_3)^2 ELSE null END) as WINS_SUM_PRCT_Differences_sqr_1_3,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 <= -1 Then ((advertiser_price_1 - advertiser_price_4)/advertiser_price_4)^2 ELSE null END) as WINS_SUM_PRCT_Differences_sqr_1_4,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 <= -1 Then ((advertiser_price_1 - advertiser_price_5)/advertiser_price_5)^2 ELSE null END) as WINS_SUM_PRCT_Differences_sqr_1_5,        
--Max Price Diff        
        --MAX(case WHEN advertiser_price_1 - advertiser_price_2 <= -1 Then advertiser_price_1 - advertiser_price_2 ELSE null END) as WINS_MAX_Price_Differences_1_2, 
        --MAX(case WHEN advertiser_price_1 - advertiser_price_3 <= -1 Then advertiser_price_1 - advertiser_price_3 ELSE null END) as WINS_MAX_Price_Differences_1_3,
        --MAX(case WHEN advertiser_price_1 - advertiser_price_4 <= -1 Then advertiser_price_1 - advertiser_price_4 ELSE null END) as WINS_MAX_Price_Differences_1_4,
        --MAX(case WHEN advertiser_price_1 - advertiser_price_5 <= -1 Then advertiser_price_1 - advertiser_price_5 ELSE null END) as WINS_MAX_Price_Differences_1_5,
--Wins max prct diff         
        --MAX(case WHEN advertiser_price_1 - advertiser_price_2 <= -1 Then (advertiser_price_1 - advertiser_price_2)/advertiser_price_2 ELSE null END) as WINS_MAX_PRCT_Differences_1_2,        
        --MAX(case WHEN advertiser_price_1 - advertiser_price_3 <= -1 Then (advertiser_price_1 - advertiser_price_3)/advertiser_price_3 ELSE null END) as WINS_MAX_PRCT_Differences_1_3,
        --MAX(case WHEN advertiser_price_1 - advertiser_price_4 <= -1 Then (advertiser_price_1 - advertiser_price_4)/advertiser_price_4 ELSE null END) as WINS_MAX_PRCT_Differences_1_4,
        --MAX(case WHEN advertiser_price_1 - advertiser_price_5 <= -1 Then (advertiser_price_1 - advertiser_price_5)/advertiser_price_5 ELSE null END) as WINS_MAX_PRCT_Differences_1_5,
        
--LOSES       
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then advertiser_price_1 ELSE null END) as LOSES_SUM_advertiser_2_1_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then advertiser_price_2 ELSE null END) as LOSES_SUM_advertiser_2_2_price,

--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then advertiser_price_1 ELSE null END) as LOSES_SUM_advertiser_3_1_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then advertiser_price_3 ELSE null END) as LOSES_SUM_advertiser_3_3_price,
        
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then advertiser_price_1 ELSE null END) as LOSES_SUM_advertiser_4_1_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then advertiser_price_4 ELSE null END) as LOSES_SUM_advertiser_4_4_price,
        
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then advertiser_price_1 ELSE null END) as LOSES_SUM_advertiser_5_1_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then advertiser_price_5 ELSE null END) as LOSES_SUM_advertiser_5_5_price,
--sqr
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then advertiser_price_1^2 ELSE null END) as LOSES_SUM_advertiser_2_1_sqr_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then advertiser_price_2^2 ELSE null END) as LOSES_SUM_advertiser_2_2_sqr_price,

--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then advertiser_price_1^2 ELSE null END) as LOSES_SUM_advertiser_3_1_sqr_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then advertiser_price_3^2 ELSE null END) as LOSES_SUM_advertiser_3_3_sqr_price,
        
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then advertiser_price_1^2 ELSE null END) as LOSES_SUM_advertiser_4_1_sqr_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then advertiser_price_4^2 ELSE null END) as LOSES_SUM_advertiser_4_4_sqr_price,
        
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then advertiser_price_1^2 ELSE null END) as LOSES_SUM_advertiser_5_1_sqr_price,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then advertiser_price_5^2 ELSE null END) as LOSES_SUM_advertiser_5_5_sqr_price,        
--diff                     
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then advertiser_price_1 - advertiser_price_2 ELSE null END) as LOSES_SUM_Price_Differences_1_2,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then advertiser_price_1 - advertiser_price_3 ELSE null END) as LOSES_SUM_Price_Differences_1_3, 
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then advertiser_price_1 - advertiser_price_4 ELSE null END) as LOSES_SUM_Price_Differences_1_4, 
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then advertiser_price_1 - advertiser_price_5 ELSE null END) as LOSES_SUM_Price_Differences_1_5,                       
--diff^2 
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then (advertiser_price_1 - advertiser_price_2)^2 ELSE null END) as LOSES_SUM_Price_Differences_sqr_1_2, 
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then (advertiser_price_1 - advertiser_price_3)^2 ELSE null END) as LOSES_SUM_Price_Differences_sqr_1_3,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then (advertiser_price_1 - advertiser_price_4)^2 ELSE null END) as LOSES_SUM_Price_Differences_sqr_1_4,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then (advertiser_price_1 - advertiser_price_5)^2 ELSE null END) as LOSES_SUM_Price_Differences_sqr_1_5,                        
--Prct Diff        
...
--Prct Diff^2
--        SUM(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then ((advertiser_price_1 - advertiser_price_2)/advertiser_price_2)^2 ELSE null END) as LOSES_SUM_PRCT_Differences_sqr_1_2,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then ((advertiser_price_1 - advertiser_price_3)/advertiser_price_3)^2 ELSE null END) as LOSES_SUM_PRCT_Differences_sqr_1_3,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then ((advertiser_price_1 - advertiser_price_4)/advertiser_price_4)^2 ELSE null END) as LOSES_SUM_PRCT_Differences_sqr_1_4,
--        SUM(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then ((advertiser_price_1 - advertiser_price_5)/advertiser_price_5)^2 ELSE null END) as LOSES_SUM_PRCT_Differences_sqr_1_5       
--Max Price Diff        
        --MAX(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then advertiser_price_1 - advertiser_price_2 ELSE null END) as LOSES_MAX_Price_Differences_1_2, 
        --MAX(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then advertiser_price_1 - advertiser_price_3 ELSE null END) as LOSES_MAX_Price_Differences_1_3,
        --MAX(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then advertiser_price_1 - advertiser_price_4 ELSE null END) as LOSES_MAX_Price_Differences_1_4,
        --MAX(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then advertiser_price_1 - advertiser_price_5 ELSE null END) as LOSES_MAX_Price_Differences_1_5,
--LOSES max prct diff         
        --MAX(case WHEN advertiser_price_1 - advertiser_price_2 >= 1 Then (advertiser_price_1 - advertiser_price_2)/advertiser_price_2 ELSE null END) as LOSES_MAX_PRCT_Differences_1_2,        
        --MAX(case WHEN advertiser_price_1 - advertiser_price_3 >= 1 Then (advertiser_price_1 - advertiser_price_3)/advertiser_price_3 ELSE null END) as LOSES_MAX_PRCT_Differences_1_3,
        --MAX(case WHEN advertiser_price_1 - advertiser_price_4 >= 1 Then (advertiser_price_1 - advertiser_price_4)/advertiser_price_4 ELSE null END) as LOSES_MAX_PRCT_Differences_1_4,
        --MAX(case WHEN advertiser_price_1 - advertiser_price_5 >= 1 Then (advertiser_price_1 - advertiser_price_5)/advertiser_price_5 ELSE null END) as LOSES_MAX_PRCT_Differences_1_5,
       

FROM Intent_media_sandbox_production.LA_ppa_competition_stage_4
GROUP BY 
...
GRANT ALL on Intent_media_sandbox_production.EA_ppa_competition_report_12202014 to PUBLIC