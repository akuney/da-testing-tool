...
%default STORE_PATH         's3n://intentmedia-hawk-output/Eric_Abis/Revenue_For_Audit/SCA_HOTELS_BID';
...
(ad_call_requested_at >= com.intentmedia.pig.udf.date.StartOfDayInMillis('20130801') AND ad_call_requested_at < com.intentmedia.pig.udf.date.EndOfDayInMillis('20130831') AND  advertiser_id == 110504 ) OR 
(ad_call_requested_at >= com.intentmedia.pig.udf.date.StartOfDayInMillis('20130801') AND ad_call_requested_at < com.intentmedia.pig.udf.date.EndOfDayInMillis('20130831') AND  advertiser_id == 59777 ) OR 
(ad_call_requested_at >= com.intentmedia.pig.udf.date.StartOfDayInMillis('20130801') AND ad_call_requested_at < com.intentmedia.pig.udf.date.EndOfDayInMillis('20130831') AND  advertiser_id == 59777 ) OR 
(ad_call_requested_at >= com.intentmedia.pig.udf.date.StartOfDayInMillis('20131101') AND ad_call_requested_at < com.intentmedia.pig.udf.date.EndOfDayInMillis('20131130') AND  advertiser_id == 110504 ) OR 
(ad_call_requested_at >= com.intentmedia.pig.udf.date.StartOfDayInMillis('20130701') AND ad_call_requested_at < com.intentmedia.pig.udf.date.EndOfDayInMillis('20130731') AND  advertiser_id == 61224 ) OR 
(ad_call_requested_at >= com.intentmedia.pig.udf.date.StartOfDayInMillis('20130401') AND ad_call_requested_at < com.intentmedia.pig.udf.date.EndOfDayInMillis('20130430') AND  advertiser_id == 59528 ) ;
